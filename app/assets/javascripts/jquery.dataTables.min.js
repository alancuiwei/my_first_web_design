...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"下一页",sPrevious:"上一页"},sEmptyTable:"没有数据",sInfo:"",sInfoEmpty:"",sInfoFiltered:"(从总共 _MAX_ 项中查找)",sInfoPostFix:"",sInfoThousands:",",sLengthMenu:"显示 _MENU_ 项",sLoadingRecords:"载入...",sProcessing:"处理...",sSearch:"查询:",sUrl:"",sZeroRecords:"没有匹配项"},
...
sScrollHead:"dataTables_scrollHead ui-state-default",sScrollFoot:"dataTables_scrollFoot ui-state-default",sFooterTH:"ui-state-default"});h.extend(j.ext.oPagination,{two_button:{fnInit:function(e,j,m){var k=e.oLanguage.oPaginate,l=function(h){e.oApi._fnPageChange(e,h.data.action)&&m(e)},k=!e.bJUI?'<a class="'+e.oClasses.sPagePrevDisabled+'" tabindex="'+e.iTabIndex+'" role="button" href="#'+e.sTableId+'">'+k.sPrevious+'</a><a class="'+e.oClasses.sPageNextDisabled+'" tabindex="'+e.iTabIndex+'" role="button" href="#'+e.sTableId+'">'+k.sNext+"</a>":
