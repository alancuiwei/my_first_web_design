...
b])}function oa(a){var b=j.defaults.oLanguage;!a.sEmptyTable&&a.sZeroRecords&&"表格中没有数据！"===b.sEmptyTable&&p(a,a,"sZeroRecords","sEmptyTable");!a.sLoadingRecords&&a.sZeroRecords&&"Loading..."===b.sLoadingRecords&&p(a,a,"sZeroRecords","sLoadingRecords")}function ya(a){if(a.oScroll.bInfinite)return null;var b='<select size="1" '+('name="'+a.sTableId+'_length"')+">",c,d,f=a.aLengthMenu;if(2==f.length&&"object"===typeof f[0]&&"object"===typeof f[1])for(c=0,d=f[0].length;c<d;c++)b+='<option value="'+
...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"后一页",sPrevious:"前一页"},sEmptyTable:"表格中没有数据！",sInfo:"显示从&nbsp;&nbsp;_START_ &nbsp;&nbsp;到 _END_ &nbsp;&nbsp;&nbsp;&nbsp;总共&nbsp;&nbsp; _TOTAL_ &nbsp;&nbsp;个&nbsp;&nbsp;商品",sInfoEmpty:"显示从 0 到 0 总共 0 个商品",sInfoFiltered:"",sInfoPostFix:"",sInfoThousands:",",sLengthMenu:"显示 _MENU_ 个商品",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"查询:",sUrl:"",sZeroRecords:"没有项目！"},
