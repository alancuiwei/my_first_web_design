...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"后一页",sPrevious:"前一页"},sEmptyTable:"No data available in table",sInfo:"显示从 _START_ 到 _END_ 总共 _TOTAL_ 个商品",sInfoEmpty:"显示从 0 到 0 总共 0 个商品",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sInfoThousands:",",sLengthMenu:"显示 _MENU_ 个商品",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"查询:",sUrl:"",sZeroRecords:"No matching records found"},
