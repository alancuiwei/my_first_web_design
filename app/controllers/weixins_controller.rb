...
class WeixinsController < ApplicationController
  ...
  def create
    ...
    if params[:xml][:Event] == "subscribe"
      if @webuser!=nil
      @webuser.update_attributes(:segment=>0)
      end
    ...
    if params[:xml][:Event] == "CLICK"
      case params[:xml][:EventKey]
        ...
        when "V110"
          if @webuser!=nil
            @webuser.update_attributes(:segment=>400)
        ...
        when "V408"
          if @webuser!=nil
          @webuser.update_attributes(:segment=>408)
...
#	    render "echo", :formats => :xml
        ...
        if @webuser!=nil && @webuser.segment==400 && params[:username]==nil
          ...
          if content=="Y" || content=="y"
            @webuser.update_attributes(:segment=>401)
          ...
          @webuser.update_attributes(:segment=>402)
          ...
          @webuser.update_attributes(:segment=>403) && params[:username]==nil
          ...
          @webuser.update_attributes(:segment=>404)
          ...
          @webuser.update_attributes(:segment=>405)
          ...
          @webuser.update_attributes(:segment=>406)
          ...
          @webuser.update_attributes(:segment=>407)
